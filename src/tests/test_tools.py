...
def sample_gtfs_data():
    ...
    data.stops["PSU_HUB"] = Stop(
        stop_id="PSU_HUB", stop_name="HUB-Robeson Center", stop_lat=40.7982, stop_lon=-77.8599
    )
    ...
    data.trips["TRIP_N_001"] = Trip(
        trip_id="TRIP_N_001", route_id="N", service_id="WEEKDAY", trip_headsign="Campus Loop North"
    )
